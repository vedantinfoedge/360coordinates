...
UPDATE admin_users SET phone = '917057714677' WHERE id = 1;
...
VALUES ('admin', 'admin@demo1.360coordinates.com', '917057714677', 'Admin User', 'super_admin', 1, NOW())
ON DUPLICATE KEY UPDATE phone = '917057714677';
